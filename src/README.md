...
[![License](https://img.shields.io/github/license/peekjef72/andrewbmchugh-flow-panel)](LICENSE)

The Flow-Extented plugin provides side-by-side metric visualization on SVG diagrams. You provide the SVG diagram along with configuration on how you want the diagram to behave. The panel then combines these with your time-series data to bring your diagram to life.

## Example 1
![example1](https://github.com/peekjef72/andrewbmchugh-flow-panel/blob/main/src/img/example1.png?raw=true)

## Example 2
![example2](https://github.com/peekjef72/andrewbmchugh-flow-panel/blob/main/src/img/example2.png?raw=true)

## Example 3
![example3](https://github.com/peekjef72/andrewbmchugh-flow-panel/blob/main/src/img/threadHighlighting.gif?raw=true)
